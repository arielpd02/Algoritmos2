...
TEST(diccionario,dicc_string_bool){
    ...
    ASSERT_FALSE(d.def(" "));
    d.definir("Clave", true);
    d.definir("Clave 2", false);
    ASSERT_TRUE(d.def("Clave"));
    ASSERT_TRUE(d.def("Clave 2"));
    ASSERT_EQ(d.obtener("Clave"),true);
    ASSERT_EQ(d.obtener("Clave 2"), false);
}
